//
//  AvatarMessageViewController.swift
//  khaddem
//
...
class AvatarMessageViewController: UIViewController {
    ...
    @IBAction func submitButtonTapped(_ sender: Any) {
        ...
        let alert = UIAlertController(title: "Avatar message sent", message: "Your avatar message has been sent successfully", preferredStyle: .alert)
...
extension AvatarMessageViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
