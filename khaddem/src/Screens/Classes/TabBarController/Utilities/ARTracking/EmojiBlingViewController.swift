//
//  EmojiBlingViewController.swift
//  khaddem
//
//  Created by Gudisi, Manjunath on 17/08/19.
...
class EmojiBlingViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    func convert(rect: CGRect) -> CGRect {
        ...
        // 2
        let point = previewLayer?.layerPointConverted(fromCaptureDevicePoint: rect.size.cgPoint)
        
        // 3
        return CGRect(origin: origin, size: point!.cgSize)
    }
...
extension EmojiBlingViewController {
    ...
    fileprivate func setupWriter() {
        do {
            ...
            let videoPathURL = URL(fileURLWithPath: outputPath)
            videoWriter = try AVAssetWriter(url: videoPathURL, fileType: AVFileType.mp4)
